...
const Root = () => {
  ...
  <C>1</C><Element css={[`height: ${variables.spaceSize1}; background-color: ${variables.primaryColor};`]}/>
  <C>2</C><Element css={[`height: ${variables.spaceSize2}; background-color: ${variables.primaryColor};`]}/>
  <C>3</C><Element css={[`height: ${variables.spaceSize3}; background-color: ${variables.primaryColor};`]}/>
  <C>4</C><Element css={[`height: ${variables.spaceSize4}; background-color: ${variables.primaryColor};`]}/>
  <C>5</C><Element css={[`height: ${variables.spaceSize5}; background-color: ${variables.primaryColor};`]}/>
  <C>6</C><Element css={[`height: ${variables.spaceSize6}; background-color: ${variables.primaryColor};`]}/>
  ...
  <Element css={[examplesContainer]}>
    ...
    <Area css={[example]}>
      <H3>Horizontal</H3>
      <LineX/>
      <Element css={[`display: flex; align-items: baseline;`]}>
    ...
    <Area css={[example]}>
      <Element css={[`display:flex; text-align: center;`]}>
        {range5.map((e, i) => (<React.Fragment key={e}>
          {i > 0 && <LineY/>}
          <Element css={[`flex:1 1`]}>
            <C><A href="">Action</A></C>
          </Element>
        </React.Fragment>))}
      </Element>
